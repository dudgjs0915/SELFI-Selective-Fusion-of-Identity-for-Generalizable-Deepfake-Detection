...
def get_test_metrics(y_pred, y_true, img_names):
    def get_video_metrics(image, pred, label):
        ...
        # Use zip to iterate over image, pred, label together
        for img_path, pred_val, label_val in zip(image, pred, label):
            ...
            result_dict[a].append([img_path, pred_val, label_val])
